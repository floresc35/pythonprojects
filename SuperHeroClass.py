...
superFirstName = ['Wonder', 'Whatta', 'Real', 'Incredible', 'Astonihing', 'Decent', 'Stupendous', 'Above-average', 'That Guy', 'Darth']

superLastName = ['Boy', 'Man', 'Dingo', 'Body', 'Girl', 'Woman', 'Guy', 'Hero', 'Max', 'Dream', 'Macho Man', 'Stallion']
...
# Letting the user chooose which type of hero to create
...
if answer2=='1':
    ...
    print("You super power is: ", hero.power)
    ...
    # Creating dramatic effect
        ...
        print("You super power is: ", hero2.power)
        print("Your new stats are:")
        print("")
    ...
    # Creating dramatic effect
        ...
        print("You super power is: ", hero3.power)
        print("Your new stats are:")
        print("")
